...
public class MainActivity extends AppCompatActivity implements ListAdapter.AdapterCallback, FragmentManager.OnBackStackChangedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList.addAll(Arrays.asList("Example 1", "Example 2", "Example 3", "Example 4", "Example 5", "Example 6"));
    ...
    public void onClick(int position) {
        if (position == 0) {
            ...
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.main_container, new com.example.sawai.coordinatorlayoutexamples.Example6.ExFragment())
                    .addToBackStack(null)
                    .commit();
        }
    }
